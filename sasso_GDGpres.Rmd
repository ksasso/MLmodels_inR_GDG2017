...
- May be less likely to over-fit the training data
...
- May be more likely to over-fit the training data
- Has been shown to yield better accuracy than bagging
...
## Implimenting Random Forest and Gradient Boosting in R
